...
## Inspect first
- Read `AGENTS.md`, the applicable files in `.agents/rules/`, and the relevant project context.
...
5. Update the relevant rule or project context documentation when the metric introduces a new concept, formula, or response field.
